...
<link rel="alternate icon"
	type="/res/img/xishanlogo.png"
	href="/res/img/xishanlogo.png">
<link rel="stylesheet"
	href="/res/css/amazeui.css" />
<link rel="stylesheet"
...
<body>
			...
			<div class="am-collapse am-topbar-collapse right"
				...
				<div class=" am-topbar-left am-form-inline am-topbar-right"
					...
					<ul class="am-nav am-nav-pills am-topbar-nav hw-menu">
						...
						<li class="hw-menu-active"><a href="../lxwm/index.htm">联系我们</a></li>
					</ul>
				</div>
		...
		<div class="am-container-1">
			<div class="toppic-title left">
				<i class="am-icon-paper-plane toppic-title-i"></i> <span
					class="toppic-title-span">关于我们</span>
				<p>About Us</p>
			</div>
			<div class="right toppic-progress">
				<span><a href="index.html" class="w-white">首页</a></span> <i
					class=" am-icon-arrow-circle-right w-white"></i> <span><a
					href="about-us.html" class="w-white">关于我们</a></span>
			</div>
		</div>
	</div>
		...
		<div class="am-collapse am-topbar-collapse right"
			...
			<div class=" am-topbar-left am-form-inline am-topbar-right"
				...
				<!-- <div class="left am-u-sm-12 am-u-md-4 am-u-lg-3"> -->
					<ul class="am-list">
						<li><a href="company-inform.htm">公司介绍</a></li>
						<li><a href="organize-inform.htm">组织机构</a></li>
						<li><a href="team-inform.htm">技术团队</a></li>
						<li><a href="ent-culture-inform.htm">企业文化</a></li>
						<li><a href="honor-inform.htm">资质荣誉</a></li>
						<li><a href="history-inform.htm">历史沿革</a></li>
					</ul>
			...
			<div class=" am-container-1">
				<div class="part-title part-title-mar">
					<a href="customer-case.html"> <i
						class=" am-icon-paper-plane part-title-i"></i> <span
						class="part-title-span">关于西山</span>
						<p>About Xishan</p>
					</a>
				</div>
	...
	<div class=" am-container-1">
		<div class="part-title part-title-mar">
			<a href="customer-case.html"> <i
				class=" am-icon-home part-title-i"></i> <span
				class="part-title-span">办公环境</span>
				<p>Office Space</p>
			</a>
		</div>
		<div class="office-space">
			<div class="cam-u-lg-6 am-u-md-6 am-u-sm-12">
				<img src="${pageContext.request.contextPath}/res/img/space-1.png" />
			</div>
			<div class="cam-u-lg-3 am-u-md-3 am-u-sm-6">
				<img src="${pageContext.request.contextPath}/res/img/space-2.png" />
			</div>
			<div class="cam-u-lg-3 am-u-md-3 am-u-sm-6">
				<img src="${pageContext.request.contextPath}/res/img/space-3.png" />
			</div>
			<div class="cam-u-lg-3 am-u-md-3 am-u-sm-6">
				<img src="${pageContext.request.contextPath}/res/img/space-4.png" />
			</div>
			<div class="cam-u-lg-3 am-u-md-3 am-u-sm-6">
				<img src="${pageContext.request.contextPath}/res/img/space-5.png" />
			</div>
			<div class="clear"></div>
		</div>
