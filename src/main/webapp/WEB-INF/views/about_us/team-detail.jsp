		...
		<div class="mainbox">
			<div class="maintitle">
				...
				<h3 style="text-align: left; text-indent: 24px;">
					<a target="_parent" href="${pageContext.request.contextPath}/index.html">首页</a> &gt; <a
						target="_parent" href="${pageContext.request.contextPath}/index.html"></a> <a target="_parent"
						href="${pageContext.request.contextPath}/gyxs/index.html">关于我们</a> &gt; <a target="_parent"
						href="${pageContext.request.contextPath}/gyxs/index.html"></a> <a target="_parent"
						href="${pageContext.request.contextPath}/gyxs/team-inform.html">技术团队</a> <label><a
						href="javascript:history.back()">返回</a></label> &gt; ${team.teamName}
				</h3>
			</div>
			<div class="jobs_detail">
				...
				<br>
				<div>
					<p style="text-align: right;">${team.teamDescription }</p>
					<p>&nbsp;</p>
					<p style="text-align: center;">
						<img src="${pageContext.request.contextPath}/image/photo.html?imgName=${team.teamPic }" alt="" height="294" width="300">
					</p>
					<p>${team.teamInfo }</p>
					<p>&nbsp;</p>
				</div>
