			...
			<div class="maintitle">
				...
				<h3 style="text-align: left; text-indent: 24px;">
					<a target="_parent" href="/index.html">首页</a> &gt; <a
						...
						href="/gyxs/index.html"></a> <a target="_parent"
						href="/gyxs/team-inform.html">技术团队</a> <label><a
			...
			<div class="jobs_detail">
				...
				<div>
					...
					<p style="text-align: center;">
						<img src="/image/photo.html?imgName=${team.teamPic }" alt="" height="294" width="300">
					</p>
					<p>${team.teamInfo }</p>
					<p>&nbsp;</p>
				</div>
