...
<div class="toppic">
	 ...
	 <div class="toppic-title left">
			<i class="am-icon-history toppic-title-i"></i>
			<span class="toppic-title-span">公司介绍</span>
			<p>Company Center</p>
		</div>
		<div class="right toppic-progress">
			<span><a href="${pageContext.request.contextPath}/gyxs/index.html" class="w-white">关于西山</a></span>
	...
	<p>
		<span style="font-size: larger">
			<span style="font-size: small">
				<span style="text-align: justify; line-height: 23px; text-indent: 32px; color: rgb(51,51,51)">
				${p.companyInfo }
				</span>
			</span>
		</span>
