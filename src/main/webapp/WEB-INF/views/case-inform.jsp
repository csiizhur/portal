...
<header class="am-topbar header">
  ...
  <div class="am-collapse am-topbar-collapse right" id="doc-topbar-collapse">
    ...
    <div class=" am-topbar-left am-form-inline am-topbar-right" role="search">
      ...
      <li class="hw-menu-active"><a href="${pageContext.request.contextPath}/xwhd/index.htm">新闻动态</a></li>
	    	...
	    	<div class="product-content">
			    	...
			    	<div class="product-show-content">			    		
			    		<div class="product-intro case-inform">
			    		  ...
			    		  <img src="${pageContext.request.contextPath}/res/img/erweima.png" />
			    		</div>
			    	</div>
			    	</div>
			    	<div class="right am-u-sm-12 am-u-md-6 am-u-lg-6 product-content-right">
			    		<img class="case-img" src="${pageContext.request.contextPath}/res/img/case1.png" />
			    	</div>	
			    	<div class="clear"></div>
	    	</div>
