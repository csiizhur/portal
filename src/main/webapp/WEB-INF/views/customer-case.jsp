...
<header class="am-topbar header">
  ...
  <div class="am-collapse am-topbar-collapse right" id="doc-topbar-collapse">
    ...
    <div class=" am-topbar-left am-form-inline am-topbar-right" role="search">
      ...
      <li><a href="${pageContext.request.contextPath}/lxwm/index.htm">联系我们</a></li>
  ...
  am-avg-md-3 am-avg-lg-4 am-gallery-bordered customer-case-ul" data-am-gallery="{  }" >
      <li>
        <div class="am-gallery-item">
            <a href="case-inform.html" class="">
              ...
              <img src="${pageContext.request.contextPath}/res/img/app1-1.png" />
             </div>
      ...
      <li>
        <div class="am-gallery-item">
            <a href="#" class="">
            	<div class="customer-case-img">
              <img src="${pageContext.request.contextPath}/res/img/app2-2.png"  />
             </div>
      ...
      <li>
        <div class="am-gallery-item">
            <a href="#" class="">
            	<div class="customer-case-img">
              <img src="${pageContext.request.contextPath}/res/img/app3-3.png" />
             </div>
      ...
      <li>
        <div class="am-gallery-item">
            <a href="#" class="">
            	<div class="customer-case-img">
              <img src="${pageContext.request.contextPath}/res/img/app4-4.png"/>
             </div>
      ...
      <li>
        <div class="am-gallery-item">
            <a href="#" class="">
            	<div class="customer-case-img">
              <img src="${pageContext.request.contextPath}/res/img/app5-5.png" />
      ...
      <li>
        <div class="am-gallery-item">
            <a href="#" class="">
            	<div class="customer-case-img">
              <img src="${pageContext.request.contextPath}/res/img/app6-6.png"  />
             </div>
                <h3 class="am-gallery-title">物流红娘</h3>
                <div class="am-gallery-desc gallery-words">一款响应式商城模板，是专门针对中小物流企业的实际业务需求量身定做的物流管理系统，具有界面简洁、流程灵活、操作方便、易于实施的特点。 该产品基于领先的云计算技术，用户无需在本地安装软件、无需专业的IT人员进行维护即可使用在线物流软件。</div>
            </a>
      ...
      <li>
        <div class="am-gallery-item">
            <a href="#" class="">
            	<div class="customer-case-img">
              <img src="${pageContext.request.contextPath}/res/img/app7-7.png" />
             </div>
                <h3 class="am-gallery-title">车型湖北</h3>
                <div class="am-gallery-desc gallery-words">一款响应式商城模板，是专门针对中小物流企业的实际业务需求量身定做的物流管理系统，具有界面简洁、流程灵活、操作方便、易于实施的特点。 该产品基于领先的云计算技术，用户无需在本地安装软件、无需购买专门的服务器硬件、无需专业的IT人员进行维护， 只要打开浏览器，登录网站，即可使用在线物流软件。</div>
            </a>
      ...
      <li>
        <div class="am-gallery-item">
            <a href="#" class="">
            	<div class="customer-case-img">
              <img src="${pageContext.request.contextPath}/res/img/app8-8.png"/>
             </div>
                <h3 class="am-gallery-title">管理系统</h3>
                <div class="am-gallery-desc gallery-words">一款响应式商城模板，是专门针对中小物流企业的实际业务需求量身定做的物流管理系统，具有界面简洁、流程灵活、操作方便、易于实施的特点。 该产品基于领先的云计算技术，用户无需在本地安装软件、无需购买专门的服务器硬件、无需专业的IT人员进行维护， 只要打开浏览器，登录网站，即可使用在线物流软件。
        </div>
...
<div class="customer  am-container-1">
		...
		<div class="am-slider am-slider-default am-slider-carousel part-all" data-am-flexslider="{itemWidth:150, itemMargin: 5, slideshow: false}" style="  background-color: #f0eeed; box-shadow:none;">
		  <ul class="am-slides">
		    <li><img src="${pageContext.request.contextPath}/res/img/ptn4.png"/></li>
		    <li><img src="${pageContext.request.contextPath}/res/img/ptn5.png"/></li>
		    <li><img src="${pageContext.request.contextPath}/res/img/ptn6.png"/></li>
		    <li><img src="${pageContext.request.contextPath}/res/img/ptn7.png"/></li>
		    <li><img src="${pageContext.request.contextPath}/res/img/ptn8.png"/></li>
		    <li><img src="${pageContext.request.contextPath}/res/img/ptn4.png"/></li>
		    <li><img src="${pageContext.request.contextPath}/res/img/ptn5.png"/></li>
		    <li><img src="${pageContext.request.contextPath}/res/img/ptn6.png"/></li>
		    <li><img src="${pageContext.request.contextPath}/res/img/ptn7.png"/></li>
